		...
		reviews: [
			{
				...
				description:
					'Скажу честно, я&nbsp;абсолютно не&nbsp;знаток оригинальной игры Dungeons &amp;&nbsp;Dragons, зато люблю фильмы про драконов. Особенно фильмы категории Б&nbsp;&mdash; именно&nbsp;те, которые в&nbsp;золотые времена крутили по&nbsp;каналу ТВ-3. Долго я&nbsp;обходил стороной этот фильм, так как немного не&nbsp;мой профиль&nbsp;&mdash; солидный бюджет и&nbsp;не&nbsp;последние актеры в&nbsp;главных ролях, но&nbsp;наличие видеосиквелов, которые как раз должны подходить под рамки низкобюджетных фэнтези сделали свое дело, и&nbsp;я&nbsp;решился ознакомиться с&nbsp;оригиналом.'
			},
			{
				id: 2,
				user: {
