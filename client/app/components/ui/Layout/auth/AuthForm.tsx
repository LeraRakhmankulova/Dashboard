...
const AuthForm: FC = () => {
	...
	return (
		<div className={style.wrapper} ref={ref}>
			{user ? (
				<UserAvatar title="Перейти на доску"
				link="/dashboard" avatarPath={user.avatarPath || ''} />
			) : (
			...
			<motion.div  transition={{ duration: 1 }} animate={isShow? 'open' : 'closed'} variants={menuAnimation}>
